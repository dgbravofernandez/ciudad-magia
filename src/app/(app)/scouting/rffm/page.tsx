...
export default async function RffmPage() {
  ...
  const SIGNAL_COLS = 'id,codjugador,nombre_jugador,nombre_equipo,nombre_competicion,nombre_grupo,cod_tipojuego,cod_temporada,goles,partidos_jugados,goles_por_partido,anio_nacimiento,division_level,valor_score,estado'
